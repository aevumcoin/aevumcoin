...
unsigned int nStakeTargetSpacing = 180;			// 1 minute block spacing

int64 nChainStartTime = 1411590077;
...
const string strMessageMagic = "AevumCoin Signed Message:\n";
...
{
    int64 nSubsidy = 222 * COIN;

    if(nHeight == 1)
    {
	nSubsidy = 112200ULL * COIN;  //Proof of distribution
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in AevumCoin
    bool fStrictPayToScriptHash = true; // Always active in AevumCoin
...
bool CBlock::AcceptBlock()
{
	...
	//AEVUM will be pure PoW until modifier_switch_block
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "AevumCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "For infitiny time.";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("d545036443982b37bf957b3505adf04329b5151f78776a8670b00f4a8ed7166b")); //merkleroot of AEVUM
